...
export function BidNode({ data, selected }: NodeProps) {
  ...
  return (
    <div className={`relative flex items-center gap-3 px-4 py-2 bg-zinc-950 rounded-full border-2 transition-all duration-200 group ${containerStyle} min-w-[180px]`}>
      ...
      <div className="bg-emerald-600 p-2 rounded-xl flex items-center justify-center shrink-0">
         <Gavel size={16} className="text-zinc-50" />
      </div>
      
      <div className="flex flex-col">
         <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Lance Max</span>
